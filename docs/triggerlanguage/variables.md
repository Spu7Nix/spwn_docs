...
Since you can't really print `Hello, world!` to the console using Geometry Dash triggers, we're going to get straight into the main features of SPWN, first of which being **variables**.
...
> _**Note:** There is no case when using SPWN where you **have** to use constant variables, but it is seen as good programming ettiquette to only let your variables be mutable when needed._
